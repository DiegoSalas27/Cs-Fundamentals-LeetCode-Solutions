...
/*
  ...
  intuition for solving the problem with dp.
  ...
  greater than the amount of money on house at index 0, after walking through 2 adjacent houses
  ...
  calculation of robbing up to two houses and compare it with computed calculation of robbing up to 3 houses.

  As we can see, we are iterating through the array and we are asking ourselves how much money we can rob if
  we rob up to 1 house, up to 2 houses, up to 3 houses, etc. and we are building up our solutions based on 
  previous calculations and here is where dynamic programming can help us as we iterate over the array 
  while working our way up based on previous indexes calculations.
